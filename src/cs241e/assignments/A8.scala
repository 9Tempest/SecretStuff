...
A A x
  ...
  lazy val twoXes = new Tree(Token("S"), Seq(
    new Tree(Token("BOF")),
    new Tree(Token("A"), Seq(
  ...
  lazy val threeXes = new Tree(Token("S"), Seq(
    new Tree(Token("BOF")),
    new Tree(Token("A"), Seq(
      new Tree(Token("A"), Seq(new Tree(Token("A"), Seq(new Tree(Token("x")))), new Tree(Token("x")))),
      new Tree(Token("x"))
    )),
    new Tree(Token("EOF"))
  ))
...
A A x A
  ...
  /** A parse tree of some string for which `ambiguousGrammar` is ambiguous. "BOF x x x x x EOF" */
  lazy val tree1 = new Tree(Token("S"), Seq(
    new Tree(Token("BOF")),
    new Tree(Token("A"), Seq(
      new Tree(Token("A"), Seq(new Tree(Token("A"), Seq(new Tree(Token("x")))), new Tree(Token("x")), new Tree(Token("A"), Seq(new Tree(Token("x")))))),
      new Tree(Token("x")),
      new Tree(Token("A"), Seq(new Tree(Token("x"))))
    )),
    new Tree(Token("EOF"))
  ...
  lazy val tree2 = new Tree(Token("S"), Seq(
    new Tree(Token("BOF")),
    new Tree(Token("A"), Seq(
      new Tree(Token("A"), Seq(new Tree(Token("x")))),
      new Tree(Token("x")),
